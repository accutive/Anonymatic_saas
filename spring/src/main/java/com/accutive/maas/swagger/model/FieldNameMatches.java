...
public class FieldNameMatches   {
  ...
  public FieldNameMatches name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public FieldNameMatches suggestedOperator(String suggestedOperator) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FieldNameMatches fieldNameMatches = (FieldNameMatches) o;
    return Objects.equals(this.name, fieldNameMatches.name) &&
        Objects.equals(this.suggestedOperator, fieldNameMatches.suggestedOperator);
  }
  ...
  public String toString() {
    ...
    sb.append("class FieldNameMatches {\n");
